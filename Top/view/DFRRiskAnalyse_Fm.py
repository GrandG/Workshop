...
class Ui_DFRRiskAnalyse(object):
    def setupUi(self, DFRRiskAnalyse):
        ...
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.tabInputDescribe)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 721, 281))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.groupBoxInput = QtWidgets.QGroupBox(self.verticalLayoutWidget_2)
        ...
        self.verticalLayoutWidget = QtWidgets.QWidget(self.taBOM)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 721, 281))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.tableWidgetBOM = QtWidgets.QTableWidget(self.verticalLayoutWidget)
        self.tableWidgetBOM.setObjectName("tableWidgetBOM")
        self.tableWidgetBOM.setColumnCount(0)
        self.tableWidgetBOM.setRowCount(0)
        self.verticalLayout.addWidget(self.tableWidgetBOM)
